...
curl -X POST http://127.0.0.1:5000/produtos -H "Content-Type: application/json" -d '{"nome": "Chocovelvet"}'
echo ""
echo ""
echo ""
sleep 4
...
curl -X POST http://127.0.0.1:5002/produtos -H "Content-Type: application/json" -d '{"nome": "Termo"}'
echo ""
echo ""
echo ""
sleep 4
...
echo -e "${GREEN}✓ Container 2 - Produto ID 1${NC}"
curl http://127.0.0.1:5001/produtos/1
echo ""
echo ""
echo ""
sleep 4
...
echo -e "${GREEN}✓ Container 3 - Atualizando ID 3${NC}"
curl -X PUT http://127.0.0.1:5002/produtos/3 -H "Content-Type: application/json" -d '{"nome": "Mister-M"}'
echo ""
echo ""
echo ""
sleep 4
...
echo -e "${GREEN}✓ Container 1 - Deletando ID 1${NC}"
